...
const routes: Routes = [
  ...
  { path: 'admin/profile', component: AdminMyprofileComponent },
  {path: 'admin/edit-profile', component: AdminEditProfileComponent},
  {path: 'admin-patient-manager', component: AdminPatientManagementComponent},
  { path: 'admin/add-patient', component: AdminAddPatientComponent },
  { path: 'admin/edit-patient/:id', component: AdminEditPatientComponent },
  { path: 'admin/patient-medical-folder/:id', component: AdminPatientMedicalFolderComponent },
  ...
  {path: 'admin/edit-doctor/:id', component: AdminEditDoctorsComponent },
  {path: 'medecin-profil', component: MedecinProfileComponent },
  {path: 'Medecin/edit-profile', component: MedecinEditProfileComponent },
  { path: 'medecins-patient-liste', component: MedecinsPatientListeComponent },
  {path: 'medecin/patient-medical-folder/:id', component: MedecinDossierPatientComponent},
  {path: 'medecin_survival_analysis', component:  MedecinsSurvivalPredictionComponent},
   { path: 'medecins-recommandation-traitement', component: MedecinsRecommandationTraitementComponent },
   { path: 'lung-cancer-prediction', component: LungCancerPredictionComponent },
  ...
  { path: 'patient-dossier-medecale/:id', component: PatientDossierMedecaleComponent },
  { path: 'resultat-predection-survival/:id', component: ResultatPredectionSurvivalComponent },

  { path: 'resultat-recomandation-traitement/:id', component: ResultatRecomandationTraitementComponent },


  {path: 'medecins-predection-lung-cancer', component: MedecinsPredectionLungCancerComponent },

 { path: 'resultat-prediction-lung-cancer/:id', component: ResultatPredictionLungCancerComponent },
 { path: 'articles-pubmed', component: ArticlesPubmedComponent },
